...
const Users = () => {
    ...
    <Container>
        <ScrollView horizontal showsHorizontalScrollIndicator={false}style={{paddingLeft: 11}}>
            ...
            <User>
                <Avatar source={require('../assets/user6.jpg')} online={true}/>
            </User>
            <User>
                <Avatar source={require('../assets/user4.jpg')} online={true}/>
            </User>
            <User>
                <Avatar source={require('../assets/user8.jpg')} online={true}/>
            </User>
            <User>
                <Avatar source={require('../assets/user7.jpg')} online={true}/>
            </User>
            <User>
